  ...
  <StyledModal
    ...
    >
        <Box width={400} height={280} backgroundColor={"background.default"} color={"text.primary"} padding={3} borderRadius={5}>
            <Typography variant="h6" color="gray" textAllign="center">
                Create Post
            </Typography>
            <UserBox>
                    <Avatar
                    sx={{width:30, height:30}}src="https://wallpaperaccess.com/full/386762.jpg"/>
                <Typography fontWeight={500} variant="span">Jaiden Miller</Typography>
            </UserBox>
            <TextField
            sx={{width:"100%"}}
